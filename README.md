...
2.การติดตั้ง API
  ...
  2.8 Test API ด้วย http://<ip เครื่องที่ติดตั้ง>:3001
3.การเรียกใช้งาน
  3.1 เตรียมข้อมูลในรูปแบบ json โดยมี column ตามมาตรฐาน drg เช่น pdx, sdx1-12, proc1-20 เป็นต้น
  3.2 call ด้วย POST http://<ip เครื่องที่ติดตั้ง>:3001/seeker ตัวแปร data
  3.2 ตัวแปรที่ส่งไปยัง API
    3.2.1 data เป็น array of object ทั้งนี้ควรส่งไม่เกิน 100 rows
